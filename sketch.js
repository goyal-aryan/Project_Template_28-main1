...
//function for creating arrows when key is pressed
function keyPressed() {
    if (keyCode === 32) {
...
//function to shoot arrows when key is released
...
//function to display arrow, show trajectory and remove arrows
